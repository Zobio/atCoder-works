...
// 最適操作は→割る割る...掛ける掛けるのはず
// なぜなら、かける操作をした後に割る操作をしても元に戻るだけだから
// だから、イメージとしては、Xとyをそれぞれ割っていって合流点を見つけていく感じになりそう
