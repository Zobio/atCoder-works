...
vector<long long> dijkstra(ll s, vector<vector<edge>> g) { 
	/*
...
int main() {
	//単一視点から始めたダイクストラ法の経路は必ず木になる(つまり閉路をもたない)
	ll n, m; cin >> n >> m;
