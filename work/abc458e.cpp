...
// 満たさない数列って要は、1と3が隣接する数列
// だから、それが何通りなのかわかれば全体から引いて計算できる
// それを数学的に求めれば良さそう

// 受験数学みたいな感じで解くなら、
// 先に1と2を並べて、そこに、いい感じに3を並べていって場合の数を数える。

// 2を最初に配置して、(両端含め)、間に1と3を良い感じに配置することを考える。
// 配置の仕方は、まずは1を「何個に分けるか」、「どこに配置するか」を考える。
// その上で、3を「何個に分けるか」、「どこに配置するか」を考える。
// いちいち計算していると間に合わなそうなので、前計算したいところ
